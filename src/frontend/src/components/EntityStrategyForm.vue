<template>
  <el-form ref="editForm" :model="form" label-width="180px" size="mini">
    ...
    <el-form-item label="Entity的公共字段">
      ...
      <help-tip content="公共字段默认是从超类中继承的，即使表里面存在相关字段也不会生成到Entity中"></help-tip>
    ...
    <el-form-item label="是否生成字段名常量" placeholder>
      ...
      <help-tip content="为每个字段生成一个静态常量，如：public static final String ID = 'test_id'"></help-tip>
    </el-form-item>
    ...
    <el-form-item label="是否移除字段的is前缀" placeholder>
      ...
      <help-tip content="比如 : 数据库字段名称 : 'is_xxx',类型为 : tinyint. 在映射实体的时候则会去掉is,在实体类中映射最终结果为 xxx"></help-tip>
    </el-form-item>

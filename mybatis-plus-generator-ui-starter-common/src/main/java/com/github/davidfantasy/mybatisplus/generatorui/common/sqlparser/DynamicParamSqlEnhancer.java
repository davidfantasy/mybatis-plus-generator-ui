...
public class DynamicParamSqlEnhancer {
     ...
     * @return
     */
    public List<com.github.davidfantasy.mybatisplus.generatorui.common.sqlparser.ConditionExpr> parseSqlDynamicConditions(String sql) {
    ...
    public String enhanceDynamicConditions(String sql) {
        List<com.github.davidfantasy.mybatisplus.generatorui.common.sqlparser.ConditionExpr> conditions = parseSqlDynamicConditions(sql);
        for (com.github.davidfantasy.mybatisplus.generatorui.common.sqlparser.ConditionExpr condition : conditions) {
    ...
    public String toDynamicSql(com.github.davidfantasy.mybatisplus.generatorui.common.sqlparser.ConditionExpr condition) {

...
public class WhereParser extends ExpressionVisitorAdapter {
    ...
    private void parseBetweenOperator(Between between) {
        if (com.github.davidfantasy.mybatisplus.generatorui.common.sqlparser.ConditionExpr.isDynamicParam(between.getBetweenExpressionStart().toString())
                || com.github.davidfantasy.mybatisplus.generatorui.common.sqlparser.ConditionExpr.isDynamicParam(between.getBetweenExpressionEnd().toString())) {
            com.github.davidfantasy.mybatisplus.generatorui.common.sqlparser.ConditionExpr condition = new com.github.davidfantasy.mybatisplus.generatorui.common.sqlparser.ConditionExpr();
    ...
    private void parseCommonOperator(Expression left, Expression right, String operator) {
        ...
        if (com.github.davidfantasy.mybatisplus.generatorui.common.sqlparser.ConditionExpr.isDynamicParam(right.toString())) {
            com.github.davidfantasy.mybatisplus.generatorui.common.sqlparser.ConditionExpr condition = new com.github.davidfantasy.mybatisplus.generatorui.common.sqlparser.ConditionExpr();

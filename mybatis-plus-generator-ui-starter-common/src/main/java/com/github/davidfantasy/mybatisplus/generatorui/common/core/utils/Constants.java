...
public final class Constants {
	 ...
	 */
	public static final String API_DOCS_URL = "${springdoc.api-docs.path:#{T(com.github.davidfantasy.mybatisplus.generatorui.common.core.utils.Constants).DEFAULT_API_DOCS_URL}}";
